...
curl -L https://raw.githubusercontent.com/smarunich/improved-goggles/master/scripts/packages.sh | bash
curl -L https://raw.githubusercontent.com/smarunich/improved-goggles/master/scripts/ansible.sh | bash
